...
/*
 * Ћесенкой называетс€ набор кубиков, в котором каждый более верхний
 * слой содержит кубиков меньше, чем предыдущий. “ребуетс€ написать
 * программу, вычисл€ющую число лесенок, которое можно построить
 * из N кубиков.
 */
